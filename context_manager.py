...
CONTEXT_FILE = "./Data/Context_Json.json"

def save_to_context(name: str, json_file: str):
    # Load entire input JSON
...
if __name__ == "__main__":
    save_to_context('test', './Data/fire_summary.json')
